...
class QuizGameUI extends EventManager {
  ...
  salir() {
    ...
    // document.dispatchEvent(new CustomEvent("quiz-end"));
  }
  ...
  avanzarJuego = async (e) => {
    ...
    if (shuffleImgs) {
      ...
      await shuffleImgs.setPromise(); // espera que termine animacion
